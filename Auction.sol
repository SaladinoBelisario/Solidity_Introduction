...
//functions
    ...
    function bid(uint _itemId, uint _count) public payable{
        ...
        */
        /*
            ...
            4.3If the id of the item for which bid is placed, is greater than 2,revert.
    ...
    function revealWinners() public {
        /*
            Iterate over all the items present in the auction.If at least on person has placed a bid, randomly select
            the winner
        */
